window.tests = {
	...
	"make": function(){
		for(var i = 0, body = $("body"); i<250; i++){
                /*
			$("<ul id='setid" + i + "' class='fromcode'></ul>")
				.append("<li>one</li><li>two</li><li>three</li>")
				.appendTo("body");
                */
			$("<ul id='setid" + i + "' class='fromcode'><li>one</li><li>two</li><li>three</li></ul>")
				.appendTo(body);
		}
	...
	"bind" : function(){
		...
		return $("ul > li").live("click", function(){ }).length;
	},
